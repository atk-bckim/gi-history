...
export default async function VSCodeCopilotPage({
  params
}: {
  params: Promise<{ locale: Locale }>;
}) {
  const { locale } = await params;
  const lesson = getLessonBySlug("/github-copilot/vscode");
  const document = getMdxDocument(locale, "/github-copilot/vscode");
