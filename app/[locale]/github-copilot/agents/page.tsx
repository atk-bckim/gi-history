...
export default async function CopilotAgentsPage({
  params
}: {
  params: Promise<{ locale: Locale }>;
}) {
  const { locale } = await params;
  const lesson = getLessonBySlug("/github-copilot/agents");
  const document = getMdxDocument(locale, "/github-copilot/agents");
